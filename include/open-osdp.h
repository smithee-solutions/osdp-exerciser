...
#define OSDP_CMDB_CONFORM_070_17_02 (1053) // next rmac-i fails...
...
int action_osdp_NAK(OSDP_CONTEXT *context, OSDP_MSG *msg);
...
int oo_filetransfer_initiate(OSDP_CONTEXT *context, char *details);
...
int oosdp_print_message_KEYPAD(OSDP_CONTEXT *ctx, OSDP_MSG *osdp_msg, char *tlogmsg);
...
int oosdp_print_message_MFG(OSDP_CONTEXT *ctx, OSDP_MSG *osdp_msg, char *tlogmsg);
...
int oosdp_print_message_POLL(OSDP_CONTEXT *ctx, OSDP_MSG *osdp_msg, char *tlogmsg);
